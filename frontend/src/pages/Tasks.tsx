...
const empty = (): Partial<Task> => ({ title: '', description: '', status: 'pending', priority: 'medium', assignee: '', dueDate: '' })
  ...
  return (
    <>
      ...
      >
        ...
        <div className={styles.formRow}>
          <Input label="Assignee" value={editing.assignee || ''} onChange={v => setEditing(e => ({ ...e, assignee: v }))} placeholder="Who's responsible?" />
